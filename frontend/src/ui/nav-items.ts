...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    path: "/workspaces",
    hotkey: "g w",
    icon: "<svg viewBox='0 0 24 24'><path d='M3 5h18v14H3zm2 2v10h14V7zm3 3h8v2H8z'/></svg>",
  },
  {
    group: "Observe",
    name: "Observability",
  ...
  },
  {
    ...
    path: "/notifications",
    hotkey: "g n",
    icon: "<svg viewBox='0 0 24 24'><path d='M12 3a6 6 0 0 0-6 6v4l-2 2v1h16v-1l-2-2V9a6 6 0 0 0-6-6zm-2 17h4a2 2 0 0 1-4 0z'/></svg>",
  },
  {
    group: "Observe",
    name: "Git & PRs",
    path: "/git",
    hotkey: "g g",
    icon: "<svg viewBox='0 0 24 24'><path d='M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 3a3 3 0 1 1 0 6 3 3 0 0 1 0-6zm0 14a7 7 0 0 1-5.7-3c.3-1.9 3.8-2.9 5.7-2.9s5.4 1 5.7 2.9A7 7 0 0 1 12 19z'/></svg>",
  },
  {
    group: "Observe",
    name: "Containers",
    path: "/containers",
    hotkey: "g d",
    icon: "<svg viewBox='0 0 24 24'><path d='M3 5h18v14H3zm2 2v4h6V7zm8 0v4h6V7zm-8 6v4h6v-4zm8 0v4h6v-4z'/></svg>",
  },
  {
    group: "System",
    name: "Settings",
