...
hooks:
  timeout_ms: 60000
  after_create: |
    echo "workspace created for $RISOLUTO_ISSUE_IDENTIFIER"
  before_run: |
...
codex:
  ...
  sandbox:
    ...
    logs:
      ...
      max_file: 3
repos:
  # This NIN route currently self-targets Risoluto for smoke/self-test traffic.
