...
Risoluto supports real-time issue updates via Linear webhooks. When configured, Risoluto reacts to issue changes within seconds instead of waiting for the next poll cycle.
...
| **Secret** | Auto-generated by Risoluto (see manual mode below)                                                                                                   |
| **Events** | Issue, Comment, IssueLabel, Project, Customer, Document, InitiativeUpdate, User, ProjectLabel, Attachment, Initiative, Reaction, Cycle, CustomerNeed |
...
| `webhook health: disconnected` | Secret not configured          | Set `webhook.webhook_secret` in overlay |
