...
> Research sources: Composio, OpenSwarm, mog, thepopebot, **jinyang**, **Orchestra**, **Eva**, **pilot**, **vibe-kanban**.
...
| [#110](https://github.com/OmerFarukOruc/symphony-orchestrator/issues/110) | MCP server for orchestrator tools — expose Symphony capabilities as MCP tools; query issues, update state, fetch metrics                                                                                                                                                   | core, api       | vibe-kanban                                              |
...
| **Tier 2** — High impact   |   44   | Not started (some extensions shipped — see notes) |
