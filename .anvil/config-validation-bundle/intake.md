...
User request on 2026-04-03: use the repo-local anvil workflow for the Config bundle from roadmap epic [#354](https://github.com/OmerFarukOruc/risoluto/issues/354), but stop after intake, brainstorm, plan, review, and synthesis audit. Do not execute implementation.
